      ...
      <main className={styles.mainSection}>
        ...
        <header className={styles.hero}>
          <div className={styles.heroContent}>
            ...
            {/* Pricing Card */}
            <div className={styles.pricingCard} style={{background: 'rgba(255,255,255,0.05)', padding: '2rem', borderRadius: '24px', marginTop: '2rem', textAlign: 'center'}}>
        ...
        <div className={styles.contentWrapper}>
          ...
          {/* How to Begin */}
          <div className={styles.section} style={{textAlign: 'center', marginTop: '3rem', marginBottom: '4rem'}}>
